...
const CACHE_NAME = 'propertyHub-v41';
const urlsToCache = [
  '/',
  '/index.html',
  '/css/styles.css',
  ...
  '/js/modules/auth.js',
  '/js/modules/automation_engine.js',
  ...
  '/js/modules/financial_decisions.js',
  '/js/modules/financial_reports.js',
  '/js/modules/insurance.js',
  '/js/modules/investment_analysis.js',
  '/js/modules/kpi_monitoring.js',
  '/js/modules/ml_analytics.js',
  '/js/modules/mobile_app.js',
  '/js/modules/mortgages.js',
  '/js/modules/permissions.js',
  '/js/modules/predictive_analytics.js',
  '/js/modules/properties.js',
  '/js/modules/refinance.js',
  '/js/modules/rent_payments.js',
  '/js/modules/scenario_analysis.js',
  '/js/modules/tasks.js',
  '/js/modules/tax_optimization.js',
  '/js/modules/tax_report.js',
  '/js/modules/tenants.js',
  '/js/modules/users.js',
